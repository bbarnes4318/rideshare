...
router.get('/export/csv', authenticateToken, requirePermission('exportData'), async (req, res) => {
  try {
    ...
    const csvData = submissions.map(sub => ({
      ...
      coverageAmount: sub.coverage_amount,
      currentlyInsured: sub.currently_insured,
      creditRating: sub.credit_rating,
      marital: sub.marital,
      homeowner: sub.homeowner,
      military: sub.military,
      tobaccoUse: sub.tobacco_use,
      cancer: sub.cancer,
      heartDisease: sub.heart_disease,
      height: sub.height,
      weight: sub.weight,
